(require 'color-theme)
(defun color-theme-vibrant-ink-inspired ()
  "Cornsilk on black.
...
widget, custom, latex, ediff."
  ...
  (color-theme-install
   '(color-theme-vibrant-ink-inspired
     ...
     (default ((t (nil))))
     (border-glyph (nil))
     (modeline ((t (:foreground "black" :background "yellow"))))
     (minibuffer-prompt ((t (:foreground "#FFDD00" :bold t))))
     (isearch ((t (:foreground "gold" :background "blue" :underline t))))
     (lazy-highlight ((t (:foreground "#FF0000" :background "#D7FF00"))))
     (trailing-whitespace ((t (:background "red"))))
     (ido-subdir ((t (:foreground "#60DCFF"))))
;     (modeline-buffer-id ((t (:foreground "black" :background "yellow"))))
     (modeline-mousable ((t (:foreground "black" :background "wheat"))))
     (modeline-mousable-minor-mode ((t (:foreground "black" :background "wheat"))))
     (highlight ((t (:foreground "wheat" :background "darkslate"))))
     (bold ((t (:bold t))))
     (italic ((t (:italic t))))
     ...
     (info-node ((t (:foreground "yellow" :italic t))))
     (info-menu-5 ((t (:underline t))))
     (info-xref ((t (:foreground "yellow" :bold t))))
     (diary-face ((t (:foreground "orange"))))
     (calendar-today-face ((t (:underline t))))
     (holiday-face ((t (:background "red"))))
     (show-paren-match-face ((t (:background "blue" :forground "brightgreen"))))
     (show-paren-mismatch-face ((t (:foreground "white" :background "red"))))
     (font-lock-comment-face ((t (:foreground "#9999CC" :italic t))))
     (font-lock-string-face ((t (:foreground "green"))))
     (font-lock-keyword-face ((t (:foreground "gold"))))
     (font-lock-builtin-face ((t (:foreground "gold"))))
     (font-lock-function-name-face ((t (:foreground "#60DCFF"))))
     (font-lock-variable-name-face ((t (:foreground "#A2FFD2"))))
     (font-lock-type-face ((t (:foreground "orange"))))
     (font-lock-constant-face ((t (:foreground "#A2FFD2"))))
     (font-lock-warning-face ((t (:foreground "color-203"))))
     ...
     ;; (ediff-current-diff-face-A ((t (:foreground "#d70000" :background "#5f0000"))))
     ;; (ediff-current-diff-face-B ((t (:foreground "DarkOrchid" :background "#5f8787"))))
     ;; (ediff-fine-diff-face-A ((t (:foreground "Navy" :background "sky blue"))))
     ;; (ediff-fine-diff-face-B ((t (:foreground "Black" :background "cyan"))))
     ;; (ediff-even-diff-face-A ((t (:foreground "Black" :background "gray10"))))
     ;; (ediff-even-diff-face-B ((t (:foreground "White" :background "gray5"))))
     ;; (ediff-odd-diff-face-A ((t (:foreground "White" :background "gray10"))))
     ;; (ediff-odd-diff-face-B ((t (:foreground "Black" :background "gray5"))))
