...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (fasd pager key-seq which-key nyan-mode ivy-hydra counsel-dash try multiple-cursors color-theme-sanityinc-tomorrow zzz-to-char rtags yatemplate wgrep company commpany use-package
          (use-package)
